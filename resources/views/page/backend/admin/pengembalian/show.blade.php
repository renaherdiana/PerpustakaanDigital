...
{{-- FOTO BUKU --}}
@if(optional($pengembalian->peminjaman->buku)->photo) <img src="{{ asset('storage/'.$pengembalian->peminjaman->buku->photo) }}" class="book-photo">
@else <img src="https://picsum.photos/200" class="book-photo">
@endif
