...
<div class="container mt-4" style="max-width:750px;">
    <div class="card shadow-sm rounded-4 p-4">
        ...
        <div class="text-center mb-4">
            <img src="{{ $foto }}" class="rounded-circle mb-3" style="width:120px; height:120px; object-fit:cover; border:3px solid #f59e0b;">
        ...
        <div class="text-center mt-4">
            <a href="{{ route('superadmin.profile.edit') }}" class="btn btn-warning px-4">✏️ Edit Profil</a>
        </div>
